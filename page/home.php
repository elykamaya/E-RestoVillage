...
<head>
  ...
  <title>WEBSITE PEMESANAN MENU MAKANAN | E-RESTO VILLAGE</title>
  ...
  <div class="wrapper">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="/">RUMAH MAKAN SEDERHANA <span class="sr-only">(current)</span></a></li>
              <!-- <li><a href="#">Link</a></li> -->
              <?php
              ...
              <?php
              if ($_SESSION['id_akses'] == 3 || $_SESSION['id_akses'] == 5) {
              ?>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Data Transaksi <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    ...
                    <small>WEBSITE PEMESANAN MAKANAN</small>
                  </p>
                </li>
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        ...
        <strong>Copyright@2021 : Pemrograman Berbasis Web - A -</br>
        Elyka Maya Ningtiyas - 192410101107</br>
        Aisyah Fanniyatuh Hayah - 192410101140</strong>
    </footer>
